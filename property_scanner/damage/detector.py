"""Visible damage analysis and repair scope contract; no implementation is provided yet."""
...
class DamageDetector:
    ...
    def run(self, context: ScanContext) -> ScanContext:
        ...
        raise NotImplementedError("Visible damage analysis and repair scope is not implemented yet.")
