"""Door, window, and opening detection contract; no implementation is provided yet."""
...
class OpeningDetector:
    ...
    def run(self, context: ScanContext) -> ScanContext:
        ...
        raise NotImplementedError("Door, window, and opening detection is not implemented yet.")
