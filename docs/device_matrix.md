...
| LiDAR | LiDAR-capable iPhone/iPad with Record3D `.r3d`, or compatible canonical RGB-D export | Metric RGB-D fusion and optional drift correction | To be filled from benchmark |
